...
public class ArticleHandlerTest {
    ...
    public void testAddGetArticle(){
        ...
        Assert.assertEquals("{\"topicID\":\"1\",\"articles\":[{\"author\":{\"firstName\":\"firstName\",\"lastName\":\"lastName\",\"speciality\":\"speciality\",\"id\":\"1\"},\"name\":\"name\",\"id\":\"1\",\"content\":\"content\"}]}", articleHandler.getArticles("1").getEntity());
        Assert.assertEquals("{\"topicID\":\"2\",\"articles\":[{\"author\":{\"firstName\":\"firstName\",\"lastName\":\"lastName\",\"speciality\":\"speciality\",\"id\":\"1\"},\"name\":\"name2\",\"id\":\"2\",\"content\":\"content2\"}]}", articleHandler.getArticles("2").getEntity());
    }
    ...
    public void deleteArticleTest(){
        ...
        Assert.assertEquals("{\"topicID\":\"1\",\"articles\":[]}", articleHandler.getArticles("1").getEntity());
        Assert.assertEquals("{\"topicID\":\"2\",\"articles\":[{\"author\":{\"firstName\":\"firstName\",\"lastName\":\"lastName\",\"speciality\":\"speciality\",\"id\":\"1\"},\"name\":\"name2\",\"id\":\"2\",\"content\":\"content2\"}]}", articleHandler.getArticles("2").getEntity());
    }
    ...
    public void updateArticleTest(){
        ...
        Assert.assertEquals("{\"topicID\":\"1\",\"articles\":[{\"author\":{\"firstName\":\"firstName\",\"lastName\":\"lastName\",\"speciality\":\"speciality\",\"id\":\"1\"},\"name\":\"name2\",\"id\":\"1\",\"content\":\"content2\"}]}", articleHandler.getArticles("1").getEntity());
        Assert.assertEquals("{\"topicID\":\"2\",\"articles\":[{\"author\":{\"firstName\":\"firstName\",\"lastName\":\"lastName\",\"speciality\":\"speciality\",\"id\":\"1\"},\"name\":\"name2\",\"id\":\"2\",\"content\":\"content2\"}]}", articleHandler.getArticles("2").getEntity());
    }
