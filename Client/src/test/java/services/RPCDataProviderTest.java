...
public class RPCDataProviderTest {
    ...
    public void addAuthorTest() {
        ...
        Assert.assertEquals(1, rpcDataProvider.getAuthors().size());
        Author author = rpcDataProvider.getAuthors().get(0);
    ...
    public void addTopicTest() {
        ...
        Assert.assertEquals(1, rpcDataProvider.getTopics().size());
        Topic topic = rpcDataProvider.getTopics().get(0);
    ...
    public void addArticleTest() {
        ...
        Assert.assertEquals(1, rpcDataProvider.getArticles(topic.getId()).size());
        Article article = rpcDataProvider.getArticles(topic.getId()).get(0);
    ...
    public void updateArticleTest() {
        ...
        Author author = rpcDataProvider.getAuthors().get(0);
        Author author2 = rpcDataProvider.getAuthors().get(1);
        rpcDataProvider.addTopic(new Topic("NAN", "name", author));
        Topic topic = rpcDataProvider.getTopics().get(0);
        rpcDataProvider.addArticle(topic.getId(), new Article("NAN", "name", "content", author));
        Article article = rpcDataProvider.getArticles(topic.getId()).get(0);
        ...
        Assert.assertEquals(1, rpcDataProvider.getArticles(topic.getId()).size());
        Article updatedArticle = rpcDataProvider.getArticles(topic.getId()).get(0);
    ...
    public void deleteArticleTest() {
        ...
        Assert.assertEquals(0, rpcDataProvider.getArticles(topic.getId()).size());
        Assert.assertEquals(1, rpcDataProvider.getAuthors().size());
    }
    ...
    public void deleteTopicTest() {
        ...
        Assert.assertEquals(0, rpcDataProvider.getArticles(topic.getId()).size());
        Assert.assertEquals(1, rpcDataProvider.getAuthors().size());
        Assert.assertEquals(0, rpcDataProvider.getTopics().size());
    }
